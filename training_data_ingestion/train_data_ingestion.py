...
class TrainDataIngestion():
    ...
    def __init__(self, train_batch_directory: str):
        ...
        # setting up logger
        self.logger = setup_logger("train_data_validation and ingestion", 
                                    log_file="logs/train_data_validation_ingestion.log")
    ...
    def data_transformation(self):
        ...
        try:
            ...
            good_files = os.path.join(self.train_data_validated, "good")
